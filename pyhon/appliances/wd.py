...
In this Python code, I've translated the Rust code into idiomatic Python, using dictionaries to represent the `HashMap` and handling JSON-like data with Python's built-in types. The comments and docstrings provide clarity on the purpose and functionality of each method, similar to the original Rust code.